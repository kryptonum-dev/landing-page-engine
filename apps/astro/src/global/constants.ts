...
/**
 * Global declaration of the MailerLite API key.
 * This constant is used for subscribing to newsletters via the MailerLite API.
 * @constant
 * @type {string}
 */
export const MAILERLITE_API_KEY: string = process.env.MAILERLITE_API_KEY || import.meta.env.MAILERLITE_API_KEY
